...
<body>
	<paper-drawer-panel>
		<paper-header-panel drawer class="cyan x-scope paper-header-panel-0" style="width:256px;">
			<paper-toolbar>
				<div class="paper-header animate">Sidebar</div>
			</paper-toolbar>
			<paper-menu>
				<a href="index.php?page=Home">
					<paper-item>Home</paper-item>
				</a>
				<a href="index.php?page=New%20Vehicle%20Registration">
					<paper-item>New Vehicle Registration</paper-item>
				</a>
				<a href="index.php?page=Auto%20Transaction">
					<paper-item>Auto Transaction</paper-item>
				</a>
				<a href="index.php?page=Driver%20License%20Registration">
					<paper-item>Driver License Registration</paper-item>
				</a>
				<a href="index.php?page=Violation%20Record">
					<paper-item>Violation Record</paper-item>
				</a>
		...
		<paper-header-panel main class="blue x-scope paper-header-panel-0" style="width:100%">
          ...
          <?php
				    ...
				    echo $header;
			    ?>
					<div style="margin-right:2%"> Logout </div>
				</div>
			</paper-toolbar>
